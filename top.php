	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="index.php"><img src="images/logo.jpg" id="section-1" class="img-responsive" alt=""/></a>
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Category</a></li>                             
							 ...
							 <li><a href="index.php#section-5"   onclick="javascript:window.open('Admin/loginform.php')">Login/Sign up</a></li>
