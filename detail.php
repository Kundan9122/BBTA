...
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>">
<input type="button" value="Enquiry" name="sbmt" /></a></td>
<td align="left" colspan="3" height="50px"><a href="booking.php?pid=<?php echo $data[0];   ?>">
<input type="button" value="Book" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
