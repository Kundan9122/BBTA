...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <div class="container">
				<p>First decide what you want to do, whether it's a general tour of a city, a day of hiking, or visiting remote villages in country. Have a ball-park time allotment in mind, whether it's a half-day, a full-day, or a multi-day experience. Once you have chosen a guide, you'll probably refine your ideas based upon the guide's knowledge.</p>
		  </div>
	  </div>
	  <div class="container">
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/<?php echo $data[3]; ?>" width="100%" height="70%" >
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">KUNDAN KUMAR</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9122607316&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 7004362244</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info[at]mytour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support[at]mytour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Christ University,Bangalore.</h5>
                        <br/>
